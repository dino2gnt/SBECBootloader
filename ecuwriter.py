...
loader = bytearray.fromhex("""4c010005E3 3780038afa000150f810b722f820378700aef83037870166f840378701a6f84537870044f85037870266f8553787026cb6cef511fa00013ab7c617657c0c7601
...
if args.rvin is not None:
   ...
   for bite in vinOffsets:
      ...
      thisResponse.append(bite)
      if args.debug:
         print("Sending command: ",thisCommand.hex())
      ser.write(thisCommand)
      response = ser.read(5)
